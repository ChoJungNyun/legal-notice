var docname = window.location.pathname.split('/').reverse(),
	...
	noticeText = '<p>This Product is Copyright © 2016, SK Holdings Co., Ltd. All Rights Reserved. </p><p>This Product uses Open Source Software (OSS). You can find the source code of these open source projects, along with applicable license information, below. We are deeply grateful to these developers for their work and contributions.</p><p>Any questions about our use of licensed work can be sent to <a href="mailto:oss.skcc@sk.com">oss.skcc@sk.com</a><p>THE FOLLOWING SETS FORTH ATTRIBUTION NOTICES FOR THIRD PARTY SOFTWARE THAT MAY BE CONTAINED IN PORTIONS OF THIS PRODUCT.</p><p>';
$(function() {
